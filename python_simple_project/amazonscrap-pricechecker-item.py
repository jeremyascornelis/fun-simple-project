...
price_value = 147 #this is the amount that you want the item to drop to in price. This is the price that maximum price that you will able to purchase the item
